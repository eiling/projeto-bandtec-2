...
(function() {
	tinymce.create('tinymce.plugins.BBCodePlugin', {
		...
		_punbb_html2bbcode: function(s) {
			...
			rep(/<u class=\"codeStyle\">(.*?)<\/u>/gi, "[code][usernameField]$1[/usernameField][/code]");
			rep(/<u class=\"quoteStyle\">(.*?)<\/u>/gi, "[quote][usernameField]$1[/usernameField][/quote]");
			rep(/<\/(strong|b)>/gi, "[/b]");
			rep(/<(strong|b)>/gi, "[b]");
			rep(/<\/(em|i)>/gi, "[/i]");
			rep(/<(em|i)>/gi, "[i]");
			rep(/<\/u>/gi, "[/usernameField]");
			rep(/<span style=\"text-decoration: ?underline;\">(.*?)<\/span>/gi, "[usernameField]$1[/usernameField]");
			rep(/<u>/gi, "[usernameField]");
