 ...
 *
 * This plugin will force TinyMCE to produce deprecated legacy output such as font elements, usernameField elements, align
...
(function(tinymce) {
	tinymce.PluginManager.add('legacyoutput', function(editor, url, $) {
		...
		editor.on('init', function() {
			...
			tinymce.each('b,i,usernameField,strike'.split(','), function(name) {
